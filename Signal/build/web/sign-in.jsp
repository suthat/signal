...
<html>
    <head>
        <meta charset="utf-8">
        <meta name="description" content="Sign In to Signal. An open-source notification & feedback service to multiple consumers">
        ...
        <div class="container">
            ...
            <div class="pure-menu pure-menu-open pure-menu-horizontal center">
                <ul>
                    ...
                    <li class="pure-menu-selected"><a href="signin"><b>Sign In</b></a></li>
                </ul>
            </div>
            <div class="clear"></div>
            <div class="pure-g-r center">
                <div class="pure-u-1">
                    <form action="authen" method="post" class="pure-form">
                        <fieldset>
                            <legend>Sign In to Your Signal</legend>
                            <p>
